 ...
 * @description: http调用工具类。包含了以https方式连接时，签名和证书的生成及验证。
 * @author: WangJinBo
 * @create: 2020-02-18 10:00
 **/
public class ApacheHttpClientUtils {

    private static Logger logger = LoggerFactory.getLogger(ApacheHttpClientUtils.class);
