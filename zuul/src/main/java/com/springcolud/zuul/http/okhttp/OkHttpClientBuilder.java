 ...
 * @description: 主要负责创建okhttpclient客户端实例
 * @author: WangJinBo
...
public class OkHttpClientBuilder {
    ...
    public OkHttpClientBuilder(long readTimeoutMilliSeconds, long writeTimeout, long connectTimeout, boolean isUnSafe,
    ...
    public OkHttpClientBuilder readTimeoutMilliSeconds(long readTimeoutMilliSeconds) {
        this.readTimeoutMilliSeconds = readTimeoutMilliSeconds;
        return this;
    }
    ...
    public OkHttpClientBuilder unSafe(boolean isUnSafe) {
        this.isUnSafe = isUnSafe;
        return this;
    }

    public OkHttpClientBuilder checkHostname(boolean isCheckHostname) {
        this.isCheckHostname = isCheckHostname;
        return this;
    }

    public OkHttpClientBuilder certificateFilePaths(Resource[] certificateFilePathsArr) {
    ...
    public OkHttpClientBuilder certificateFilePaths(List<URL> certificateFilePaths) {
        this.certificateFilePaths = certificateFilePaths;
        return this;
    }

    public OkHttpClientBuilder pkcs(String pkcsFile, String pkcsFilePwd) {
        this.pkcsFile = pkcsFile;
        this.pkcsFilePwd = pkcsFilePwd;
        return this;
    }

    public OkHttpClient buildSimple(OkHttpClientConfig config) {
    ...
    public OkHttpClient build() {
        ...
        return new OkHttpClient(readTimeoutMilliSeconds, writeTimeout, connectTimeout, sslParams);
    }
